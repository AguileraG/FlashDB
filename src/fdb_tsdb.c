...
#define FDB_LOG_PREFIX2()                         FDB_PRINT("[%s] ", (db) ? db_name(db): "(null)")
...
#define SECTOR_END0_TIME_OFFSET                  offsetof(struct sector_hdr_data, end_info[0].time)
#define SECTOR_END0_IDX_OFFSET                   offsetof(struct sector_hdr_data, end_info[0].index)
#define SECTOR_END0_STATUS_OFFSET                offsetof(struct sector_hdr_data, end_info[0].status)
#define SECTOR_END1_TIME_OFFSET                  offsetof(struct sector_hdr_data, end_info[1].time)
#define SECTOR_END1_IDX_OFFSET                   offsetof(struct sector_hdr_data, end_info[1].index)
#define SECTOR_END1_STATUS_OFFSET                offsetof(struct sector_hdr_data, end_info[1].status)
